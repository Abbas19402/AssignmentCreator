...
const Footer = () => {
    ...
    console.log(cat , subWithCat , cms);
  return (
    <div className='relative bg-dark/90 w-full h-[70vh] flex justify-center items-center'>
        <div className="flex flex-col justify-start items-center w-[80%] h-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 px-10 text-gray-300 py-5">
                    <div className='flex flex-col justify-start gap-4'>
                        ...
                        <ul className='w-full text-start px-2'>
                            {cat.data.map( item => (
                                <li>
                                    <span className="text-sm hover:text-primary hover:cursor-pointer tracking-wider leading-6">{item.name}</span>
                                </li>
                            )) }
                        </ul>
                    </div>
            ...
            {/* Policies */}
            <div className="flex flex-col lg:flex-row justify-center items-start lg:items-center w-full h-full">
